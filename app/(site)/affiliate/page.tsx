        ...
        <div className="max-w-4xl mx-auto px-6 py-12 lg:py-20">
          <div className="mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              Earn commissions by referring traders to Orchard Capitals
            </p>
          </div>
          <div className="space-y-12">
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                The Orchard Capitals Affiliate Program rewards you for introducing new traders to our
            ...
            <section>
              ...
              <div className="bg-orange-500/10 border border-orange-500/20 rounded-xl p-6 mb-6">
                <p className="text-3xl font-bold text-[#c14e2a] mb-2">10% Referral Bonus</p>
            ...
            <section>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="bg-[#c14e2a] text-white rounded-full w-10 h-10 flex items-center justify-center text-lg font-bold shrink-0">1</div>
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">Sign Up</h3>
                    <p className="text-gray-700 dark:text-gray-300">
                      Create your Orchard Capitals account and apply for the Affiliate Program through your dashboard.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="bg-[#c14e2a] text-white rounded-full w-10 h-10 flex items-center justify-center text-lg font-bold shrink-0">2</div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="bg-[#c14e2a] text-white rounded-full w-10 h-10 flex items-center justify-center text-lg font-bold shrink-0">3</div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="bg-[#c14e2a] text-white rounded-full w-10 h-10 flex items-center justify-center text-lg font-bold shrink-0">4</div>
                  <div>
            ...
            <section>
              ...
              <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-[#c14e2a] font-bold">&#8226;</span>
                  <span>Always disclose your affiliate relationship when promoting Orchard Capitals</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#c14e2a] font-bold">&#8226;</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-[#c14e2a] font-bold">&#8226;</span>
                  <span>Do not bid on Orchard Capitals branded keywords in paid advertising</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#c14e2a] font-bold">&#8226;</span>
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                Orchard Capitals reserves the right to terminate affiliate partnerships under the following
                circumstances:
              </p>
              <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                <li className="flex items-start gap-3">
            ...
            <section className="bg-gray-100 dark:bg-gray-900 rounded-2xl p-8 border-2 border-gray-200 dark:border-gray-800">
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                Join the Orchard Capitals Affiliate Program today. Sign up, get your referral link,
