          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 52 }}>
            ...
            <div>
              ...
              {[
                ...
                "Orchard Capitals (USA) Ltd authorised by SEC# 801-69167; CRD # 147179",
            ...
            <div style={{ background: `${OC}0e`, border: `1px solid ${OC}28`, borderRadius: 16, padding: "32px 28px" }}>
              <motion.h2 {...reveal} style={{ fontFamily: "var(--oc-poppins)", fontSize: "clamp(18px, 2vw, 22px)", fontWeight: 700, color: OC, marginBottom: 14, letterSpacing: "-0.3px" }}>
                5. Important Notice
              </motion.h2>
              {[
