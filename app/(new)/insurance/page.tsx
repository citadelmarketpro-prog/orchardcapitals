      ...
      <section style={{ background: WHITE, padding: "88px 24px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {COVERAGE.map(c => (
              <div key={c.title} style={{ background: GRAY, borderRadius: 16, padding: "32px 28px", border: "1px solid #e5e7eb", transition: "box-shadow 0.2s, transform 0.2s" }}
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div style={{ borderRadius: 20, overflow: "hidden", boxShadow: "0 24px 80px rgba(0,0,0,0.1)" }}>
              <img src="/landing/images/fee-ff9f34dc.png" alt="No hidden fees" style={{ width: "100%", display: "block" }} />
            </div>
            <div>
              ...
              <h2 style={{ fontFamily: "var(--oc-poppins)", fontSize: "clamp(28px, 4vw, 44px)", fontWeight: 400, lineHeight: 1.1, marginBottom: 20, letterSpacing: "-0.5px" }}>
                Protected from day one,<br /><em style={{ fontStyle: "italic", color: OC }}>automatically.</em>
              </h2>
