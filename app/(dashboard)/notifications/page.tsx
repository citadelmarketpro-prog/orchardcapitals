...
export default function NotificationsPage() {
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      ...
      case "deposit":
        return "bg-[#c14e2a]/10 dark:bg-[#c14e2a]/20 text-[#c14e2a]";
      case "withdrawal":
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
            ...
            {unreadCount > 0 && (
              <button
                ...
                className="px-4 py-2 bg-[#c14e2a] hover:bg-[#a8401f] text-white rounded-lg font-medium transition-colors text-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
                {markingAllRead ? (
                  <>
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-all ${
                  filter === option.value
                    ...
                    : "bg-white dark:bg-[#1c0f06] text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-[#2c1a0c]/50 border border-gray-200 dark:border-white/10"
                }`}
              >
                {option.label}
              ...
              <div className="space-y-3">
                {filteredNotifications.map((notification) => (
                  <motion.div
                    ...
                    className={`bg-white dark:bg-[#1c0f06] rounded-xl p-5 border transition-all duration-300 cursor-pointer ${
                      notification.read
                        ? "border-gray-200 dark:border-white/10 hover:border-gray-300 dark:hover:border-white/20"
                        : "border-[#c14e2a] dark:border-[#c14e2a] hover:border-[#a8401f] dark:hover:border-[#a8401f]"
                    }`}
                  >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-3 mb-2">
                          ...
                          <div className="flex items-center gap-2 flex-shrink-0">
                            {!notification.read && (
                              <span className="w-2.5 h-2.5 bg-[#c14e2a] rounded-full"></span>
                            )}
                          </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-xs text-[#c14e2a] hover:text-[#c14e2a] font-medium">
                            View Details →
                          </span>
                        </div>
                      </div>
      ...
      <AnimatePresence>
        {selectedNotification && (
          <>
            ...
            >
              <div
                className="bg-white dark:bg-[#1c0f06] rounded-2xl max-w-3xl w-full max-h-[95vh] flex flex-col overflow-hidden shadow-2xl"
