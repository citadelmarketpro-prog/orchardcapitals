...
function Row({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div className="flex items-center justify-between py-3 border-b border-gray-100 dark:border-white/5 last:border-0">
      ...
      <span className="text-sm text-right text-gray-900 dark:text-white">{children}</span>
    </div>
  );
}
                  ...
                  <div className="px-5 pt-2 pb-4">
                    <div className="bg-gray-50 dark:bg-white/4 rounded-xl p-4 grid grid-cols-2 gap-x-6 gap-y-5">
                      <div>
                        ...
                        <p className="text-sm font-medium text-gray-900 dark:text-white">Market</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Order ID</p>
                        <p className="text-sm font-medium text-gray-900 dark:text-white break-all">{trade.reference}</p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-gray-900 dark:text-white">{maskAccountId(accountId)}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">
                          {isFilled ? "Filled" : "Opened"}
                        </p>
                        <p className="text-sm font-medium text-gray-900 dark:text-white">{formatDate(trade.opened_at)}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Currency</p>
                        <p className="text-sm font-medium text-gray-900 dark:text-white">USD</p>
                      </div>
                    </div>
                  </div>
