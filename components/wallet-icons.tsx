export const WalletIcon = ({ type, className = "w-10 h-10" }: { type: string; className?: string }) => {
  const walletStyles: Record<string, { bg: string; text: string; label: string }> = {
    aktionariat: { bg: "bg-[#c14e2a]", text: "text-white", label: "AK" },
    ...
    bitpay: { bg: "bg-[#7a2d14]", text: "text-white", label: "BP" },
    blockchain: { bg: "bg-[#c14e2a]", text: "text-white", label: "BC" },
    coinbase: { bg: "bg-[#c14e2a]", text: "text-white", label: "CB" },
    "coinbase-one": { bg: "bg-[#c14e2a]", text: "text-white", label: "C1" },
    crypto: { bg: "bg-[#251309]", text: "text-white", label: "CR" },
    exodus: { bg: "bg-purple-700", text: "text-white", label: "EX" },
    gemini: { bg: "bg-cyan-500", text: "text-white", label: "GM" },
    imtoken: { bg: "bg-[#c14e2a]", text: "text-white", label: "IM" },
    ...
    safepal: { bg: "bg-[#a8401f]", text: "text-white", label: "SP" },
    sparkpoint: { bg: "bg-indigo-500", text: "text-white", label: "SK" },
    trust: { bg: "bg-[#c14e2a]", text: "text-white", label: "TW" },
