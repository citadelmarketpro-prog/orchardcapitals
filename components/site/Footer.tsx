      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
          ...
          <div className="lg:col-span-3">
            ...
            <p className="mb-4 text-sm text-[var(--foreground-muted)]">
              Copytrade with Orchard Capitals
            </p>
            ...
            <div className="space-y-6">
              ...
              <FooterSection
                ...
                links={[
                  ...
                  { label: "support@orchardcapitals.com", href: "mailto:support@orchardcapitals.com" },
                ]}
              />
            </div>
          </div>
        ...
        <div className="mt-8 border-t border-[var(--border)] pt-8">
          <div className="space-y-4 text-xs leading-relaxed text-[var(--foreground-muted)]">
            <p>
              Disclaimer Orchard Capitals (Europe) Ltd., a Financial Services Company
              ...
              Limassol, Cyprus. Orchard Capitals (UK) Ltd, a Financial Services
            ...
            <p>
              ...
              Under no circumstances shall Orchard Capitals have any liability to any
              ...
              Orchard Capitals by following and/or copying or replicating the trades
              ...
              performance of a Orchard Capitals Community Member is not a reliable
              indicator of his future performance. Content on Orchard Capitals&apos;s
              ...
              Orchard Capitals- Your Social Investment Network.
            </p>
            <p className="pt-4">
              Copyright &copy; 2006-2026 Orchard Capitals - Your Social Investment Network,
              All rights reserved.
            </p>
          </div>
        </div>
